...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 =new Post(null, sdf.parse("20/05/2022"), "Bom dia", "Acordei muito bem", maria);
        Post post2 =new Post(null, sdf.parse("30/01/2022"), "Boa noite", "Fui dormir muito bem", maria);
